	...
	<div class="row">
		<div class="col-sm-12">
			<div class="card">
				...
				<form class="form theme-form" action="{{route('customer.store')}}" method="POST" enctype="multipart/form-data">
					@csrf
					@method('POST')
					<div class="card-body">
						<div class="row">
							<div class="col">
								...
								<div class="mb-3 row">
									...
									<div class="col-sm-9">
										<input class="form-control" name="email" type="text" placeholder="Customer Email" value="{{old('email')}}" required>
									</div>
								</div>
								...
								<div class="mb-3 row">
									...
									<div class="col-sm-9">
										<input class="form-control" name="password" type="text" placeholder="Customer Password" value="{{old('password')}}" required>
									</div>
								</div>
								...
								<div class="mb-3 row">
									...
									<div class="col-sm-9">
										<input class="form-control" name="dob" type="date" placeholder="Customer phone" value="{{old('dob')}}" required>
									</div>
								</div>
								...
								<div class="mb-3 row">
									...
									<div class="col-sm-9">
										<input class="form-control" name="address" type="text" placeholder="Customer address" value="{{old('address')}}" required>
									</div>
								</div>
								...
								<div class="mb-3 row">
									...
									<div class="col-sm-9">
										<input class="form-control" name="prefer" type="text" placeholder="Customer prefer" value="{{old('prefer')}}" required>
									</div>
								</div>
