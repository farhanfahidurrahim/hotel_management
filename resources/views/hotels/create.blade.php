			...
			<div class="card">
                    ...
                    <div class="col-sm-9">
                      <textarea class="form-control" name="description" rows="5" cols="5" placeholder="Default textarea"></textarea>
								...
								<div class="mb-3 row">
									...
									<div class="col-sm-9">
										<input class="form-control digits" name="price" type="number" step="0.01" placeholder="price" >
									</div>
								</div>
								...
								<div class="mb-3 row">
									...
									<div class="col-sm-9">
										<input class="form-control digits" name="offer_price" type="number" step="0.01" placeholder="offer price" >
									</div>
								</div>
                ...
                <div class="mb-3 row">
								...
								<div class="mb-3 row">
									...
									<div class="col-sm-9">
										<input class="form-control m-input digits" name="contact_no" type="tel" placeholder="01234567891">
									</div>
								</div>
								<div class="mb-3 row">
								...
								<div class="mb-3 row">
									...
									<div class="col-sm-9">
										<input class="form-control" type="url" name="website_link" placeholder="https://example.com">
									</div>
								</div>
								...
								<div class="mb-3 row">
									...
									<div class="col-sm-9">
										<input class="form-control" type="url" name="youtube_link" placeholder="https://youtube.com">
									</div>
								</div>
                ...
                <div class="mb-3 row">
                 ...
                 <div class="mb-3 row">
									...
									<div class="col-sm-9">
										<input class="form-control" type="text" name="tags" placeholder="Enter Comma Separated Value">
									</div>
								</div>
